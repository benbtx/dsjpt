      ...
      btnGetGXTPJS(){
        ...
        var _this=this;
           if(this.archiveNum==[]){ this.$message('请先查询选择案件'); return;}
            ...
            if(this.$refs.graph.clickNodes.length!=1){
          ...
          this.graphLoading=true;
           http_tjs
          .getGXTPJS({twoWayMappingId:this.$refs.graph.clickNodes[0].twoWayMappingId,param:this.thcs,archiveNum:this.archiveNum})
