  ...
  <imp-panel>
      ...
      <h3 class="box-title" slot="header" style="width: 100%;">
        <el-row style="width: 100%;">
          ...
          <el-col :span="10">
            <el-button type="primary" icon="plus" @click="getToggle">子图求解</el-button>
          </el-col>
        </el-row>
      </h3>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getToggle(){
        if(!this.$refs.graph.clickNodes.length){ this.$message('请先选中节点')}
        this.$refs.graph.nodesToggle(this.$refs.graph.clickNodes)
      }
    },
    created(){
      this.getDA();
