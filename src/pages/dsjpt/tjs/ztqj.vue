      ...
      <h3 class="box-title" slot="header" style="width: 100%;">
        <el-row style="width: 100%;">
          ...
          <el-col :span="8">
              ...
              <el-button type="primary" icon="plus" @click="btnGetGLD">子图</el-button>
...
<script>
  ...
  let option= option = {
      ...
      series: [{
          ...
          draggable: true,
          roam: true,
          focusNodeAdjacency: false,//关联节点高亮其他淡化
          categories: [],
          // edgeSymbol: ['', 'arrow'],
      ...
      btnGetGLD(){
        var _this=this;
          ...
          // .getGLDJS({twoWayMappingId:this.twoWayMappingId[0]})
           .getZTQJ({twoWayMappingId:this.twoWayMappingId[0],archiveNum:this.archiveNum})
          ...
          .then(data => {
              if(data.data.code==200)
              {
                ...
                //    var jdcount=0;
                //   for (const i of  _this.gxtXRLX) { 
                //     option.series[0].links.forEach( ( item, index ) => {
                       
                //         if(item.data.id==i.id){
                //           jdcount+=1;
                //         }
                //         if(index==(  option.series[0].links.length-1)){
                //           if(jdcount==0){
                //             console.log('加了连线');
                //              option.series[0].links.push({
                //                 source: i.startPerson.name,
                //                 target: i.endPerson.name,
                //                 value: i.value,
                //                 lineStyle:{
                //                     color: '#736d6d',  //#409EFF blue 连线的颜色
                //                     width:2,
